        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              using QuizTime. By accessing or using our platform, you agree to
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    badges. We provide the platform "as is" and reserve the
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-purple-500 pl-4">
                    ...
                    <p className="text-gray-600">
                      ...
                      on QuizTime are owned by QuizTime or its licensors. You
                  ...
                  <div className="border-l-4 border-yellow-500 pl-4">
                    ...
                    <p className="text-gray-600">
                      ...
                      QuizTime a license to use, display, and distribute it
                      within the platform for service operation.
                    </p>
                  </div>
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-gray-600">
                      ...
                      your copyright has been infringed, please contact us
                      immediately.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      us or using account settings. Some data may be retained as
                      required by law.
                    </p>
                  </div>
                  <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              ...
              <section>
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    reference. Please review our Privacy Policy to understand
                    our data practices.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    QuizTime, its team, and affiliates shall not be liable for
                    any indirect, incidental, special, consequential, or
                    punitive damages, including but not limited to loss of data,
                    loss of profits, or business interruption, arising from your
                    use of the platform.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  your use of the platform, violation of these Terms, or
              ...
              <section>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    after changes constitutes acceptance of the new Terms. If
                    you don't agree with changes, you should stop using the
                    service.
                  </p>
                </div>
              </section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      and QuizTime regarding the service.
                    </p>
                  </div>
                </div>
              </section>
