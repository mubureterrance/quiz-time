        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              QuizTime collects, uses, and protects your information when you
              use our quiz platform.
            </p>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <p className="text-gray-700 leading-relaxed">
                    QuizTime may use third-party services (such as
                    authentication or analytics providers) to operate and
                    improve the app. These services may have access to certain
                    information as required to perform their functions, but they
                    are not permitted to use it for other purposes.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  preferences and enhance your experience. You can control
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  We retain your account information and quiz data for as long
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  worldwide. By using our service, you consent to the transfer
                  of your information to the Republic of Botswana.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  QuizTime is intended for users 10 years of age and older. We
                  do not knowingly collect personal information from children
                  under 10. If you are a parent or guardian and believe your
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  notify users of significant changes through the app or by
                  email.
                </p>
              </section>
            </div>
